...
# installed.
TCL_PREFIX='C:/Users/DELL/Downloads/ML project/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Users/DELL/Downloads/ML project/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Users/DELL/Downloads/ML project/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Users/DELL/Downloads/ML project/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Users/DELL/Downloads/ML project/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Users/DELL/Downloads/ML project/venv\Library\lib\tclstub86.lib'
